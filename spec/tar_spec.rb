...
describe Archiver::Tar do
  ...
  it "should correct tar text data" do
    Dir.chdir(File.dirname(__FILE__)) do
      Archiver::Tar.new.tap do |archive|
        ...
        archive.files.map(&:name).should == ['data/heneryIV.txt', 'data/heneryIV-westmoreland.txt', 'data/henryIV.txt']
        archive.write do |raw|
          #Digest::MD5.hexdigest(raw).should == "428500d94224b52844b0499af60da8d4"
        end # raw
      end # archive
    end
  end # should correct tar text data
end # Archiver::Tar
